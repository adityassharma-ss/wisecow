            ...
            <div className="sm:w-[36rem] text-l-primary mx-6 sm:mx-0">
                <div className="flex flex-col gap-2 text-5xl font-extrabold mb-6 md:flex-row">
                    <span className="relative block">
                        <span
                            className="
                            before:content-['Imagine.'] before:bg-clip-text before:absolute before:top-0 before:left-0 before:bg-l-primary before:opacity-5"
                        >
                            <span
                    ...
                    <span className="relative block">
                        <span
                            className="
                            before:content-['Craft.'] before:bg-clip-text before:absolute before:top-0 before:left-0 before:bg-l-primary before:opacity-5"
                        >
                            <span
                    ...
                    <span className="relative block">
                        <span
                            className="
                            before:content-['Enjoy.'] before:bg-clip-text before:absolute before:top-0 before:left-0 before:bg-l-primary before:opacity-5"
                        >
                            <span
                ...
                <p className="leading-7">
                    Bring a smile to someone's face with WiseCow - a beautiful
